...
IMG_PATH = osp.join(repo_path, 'images/x0.png')
...
key_points = [[41,40], [85,41], [75,66], [75,81]]
...
while True:
    ...
    leye_img =  cv2.imread("/home/shuai.li/code/Keras_TP-GAN/misc/leye.jpg")
    reye_img =  cv2.imread("/home/shuai.li/code/Keras_TP-GAN/misc/reye.jpg")
    nose_img =  cv2.imread("/home/shuai.li/code/Keras_TP-GAN/misc/nose.jpg")
    mouth_img = cv2.imread("/home/shuai.li/code/Keras_TP-GAN/misc/mouth.jpg")
    ...
    if tpgan is None:
        tpgan = TPGAN(lcnn_extractor_weights='FINE_TUNED/LCNN/EXTRACTOR/WEIGHTS.hdf5',
    ...
    cv2.imwrite("front.jpg", pred_faces[0][:,:,::-1])
